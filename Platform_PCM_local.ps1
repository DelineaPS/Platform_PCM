...
$Platform_PCMScripts = New-Object System.Collections.ArrayList

# ArrayList to hold ScriptBlocks
$Platform_PCMScriptBlocks = New-Object System.Collections.ArrayList
...
foreach ($directory in $Directories)
{
	...
	$Platform_PCMScripts.AddRange(@($folderscripts)) | Out-Null
}# foreach ($directory in $Directories)

# for each script we found
foreach ($script in $Platform_PCMScripts)
{
    ...
    $Platform_PCMScriptBlocks.Add($obj) | Out-Null
...
$global:Platform_PCMScriptBlocks = $Platform_PCMScriptBlocks
